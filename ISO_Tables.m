...
%~ AC_Huff_L = [Run | Size | Code length | Code word] ~% 0 0 EOB
AC_Huff_L = string( [0 0 4  1010;
                     0 1 2  "00";
                     0 2 2  "01";
                     0 3 3  100;
                     0 4 4  1011;
...
%~ AC_Huff_C = [Run | Size | Code length | Code word] ~% 0 0 EOB
AC_Huff_C = string( [0 0 2  "00";
                     0 1 2  "01";
                     0 2 3  100;
                     0 3 4  1010;
                     0 4 5  11000;
